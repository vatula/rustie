(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/com/robobeak/rustie/data", ["exports", "babel-runtime/helpers/create-class", "babel-runtime/helpers/class-call-check", "babel-runtime/core-js/object/define-property", "babel-runtime/core-js/object/create"], factory);
    ...
    global.comRobobeakRustieData = mod.exports;
  }
...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/com/robobeak/rustie/errors", ["exports", "babel-runtime/helpers/inherits", "babel-runtime/helpers/get", "babel-runtime/helpers/class-call-check", "babel-runtime/core-js/object/define-property"], factory);
  } else if (typeof exports !== "undefined") {
    ...
    global.comRobobeakRustieErrors = mod.exports;
  }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/index', ['exports', 'babel-runtime/core-js/object/define-property', '/com/robobeak/rustie/errors', '/com/robobeak/rustie/rustie', '/com/robobeak/rustie/plugin', '/com/robobeak/rustie/dal/reader', '/com/robobeak/rustie/dal/writer', '/com/robobeak/rustie/data'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/core-js/object/define-property'), require('/com/robobeak/rustie/errors'), require('/com/robobeak/rustie/rustie'), require('/com/robobeak/rustie/plugin'), require('/com/robobeak/rustie/dal/reader'), require('/com/robobeak/rustie/dal/writer'), require('/com/robobeak/rustie/data'));
  } else {
    var mod = {
      exports: {}
    };
    ...
    global.comRobobeakRustieIndex = mod.exports;
  }
})(this, function (exports, _babelRuntimeCoreJsObjectDefineProperty, _comRobobeakRustieErrors, _comRobobeakRustieRustie, _comRobobeakRustiePlugin, _comRobobeakRustieDalReader, _comRobobeakRustieDalWriter, _comRobobeakRustieData) {
  'use strict';

  (0, _babelRuntimeCoreJsObjectDefineProperty['default'])(exports, '__esModule', {
    value: true
  });
  exports.Rustie = _comRobobeakRustieRustie.Rustie;
  exports.RustieAbstractClassError = _comRobobeakRustieErrors.RustieAbstractClassError;
  exports.Data = _comRobobeakRustieData.Data;
  exports.Plugin = _comRobobeakRustiePlugin.Plugin;
  exports.Reader = _comRobobeakRustieDalReader.Reader;
  exports.Writer = _comRobobeakRustieDalWriter.Writer;
});
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/com/robobeak/rustie/pipeline", ["exports", "babel-runtime/helpers/create-class", "babel-runtime/helpers/class-call-check", "babel-runtime/core-js/object/define-property", "babel-runtime/regenerator", "babel-runtime/core-js/object/assign", "babel-runtime/core-js/object/create", "babel-runtime/core-js/get-iterator"], factory);
  } else if (typeof exports !== "undefined") {
    ...
    global.comRobobeakRustiePipeline = mod.exports;
  }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/plugin', ['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', '/com/robobeak/rustie/errors'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('/com/robobeak/rustie/errors'));
  } else {
    var mod = {
      exports: {}
    };
    ...
    global.comRobobeakRustiePlugin = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _comRobobeakRustieErrors) {
  'use strict';
  ...
  var Plugin = (function () {
    function Plugin() {
      ...
      if (this.constructor === Plugin) {
        throw new _comRobobeakRustieErrors.RustieAbstractClassError('cannot instantiate class Plugin. Plugin is an abstract class');
      }
    }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/rustie', ['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', '/com/robobeak/rustie/pipeline'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('/com/robobeak/rustie/pipeline'));
  } else {
    var mod = {
      exports: {}
    };
    ...
    global.comRobobeakRustieRustie = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _comRobobeakRustiePipeline) {
  'use strict';
  ...
  var Rustie = (function () {
    function Rustie(reader, writer) {
      ...
      this._reader = reader;
      this._writer = writer;
      this._pipeline = new _comRobobeakRustiePipeline.Pipeline();
    }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/dal/reader', ['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', 'babel-runtime/core-js/object/create', '/com/robobeak/rustie/errors'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('babel-runtime/core-js/object/create'), require('/com/robobeak/rustie/errors'));
  } else {
    var mod = {
      exports: {}
    };
    ...
    global.comRobobeakRustieDalReader = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _babelRuntimeCoreJsObjectCreate, _comRobobeakRustieErrors) {
  'use strict';
  ...
  var Reader = (function () {
    function Reader() {
      ...
      if (this.constructor === Reader) {
        throw new _comRobobeakRustieErrors.RustieAbstractClassError('cannot instantiate class Reader. Reader is an abstract class');
      }
    }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/dal/writer', ['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', '/com/robobeak/rustie/errors'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('/com/robobeak/rustie/errors'));
  } else {
    var mod = {
    ...
    factory(mod.exports, global._createClass, global._classCallCheck, global._Object$defineProperty, global._regeneratorRuntime, global.errors);
    global.comRobobeakRustieDalWriter = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _comRobobeakRustieErrors) {
  'use strict';
  ...
  var Writer = (function () {
    function Writer() {
      ...
      if (this.constructor === Writer) {
        throw new _comRobobeakRustieErrors.RustieAbstractClassError('cannot instantiate class Writer. Writer is an abstract class');
      }
    }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/dal/empty/null-reader', ['exports', 'babel-runtime/helpers/inherits', 'babel-runtime/helpers/get', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', '../../index'], factory);
  } else if (typeof exports !== 'undefined') {
    ...
    global.comRobobeakRustieDalEmptyNullReader = mod.exports;
  }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/dal/empty/null-writer', ['exports', 'babel-runtime/helpers/inherits', 'babel-runtime/helpers/get', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', '../../index'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/inherits'), require('babel-runtime/helpers/get'), require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('../../index'));
  } else {
    var mod = {
    ...
    factory(mod.exports, global._inherits, global._get, global._createClass, global._classCallCheck, global._Object$defineProperty, global._regeneratorRuntime, global.index);
    global.comRobobeakRustieDalEmptyNullWriter = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersInherits, _babelRuntimeHelpersGet, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _index) {
  'use strict';
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/plugins/front-matter/index', ['exports', 'babel-runtime/helpers/inherits', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', 'babel-runtime/core-js/object/keys', 'babel-runtime/core-js/object/create', '/com/robobeak/rustie/index', '/com/robobeak/rustie/plugins/front-matter/js-yaml', 'babel-runtime/helpers/interop-require-default'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/inherits'), require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('babel-runtime/core-js/object/keys'), require('babel-runtime/core-js/object/create'), require('/com/robobeak/rustie/index'), require('/com/robobeak/rustie/plugins/front-matter/js-yaml'), require('babel-runtime/helpers/interop-require-default'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  var _jsyaml = (0, _babelRuntimeHelpersInteropRequireDefault['default'])(_comRobobeakRustiePluginsFrontMatterJsYaml);
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    global.comRobobeakRustiePluginsMarkdownIndex = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersInherits, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _babelRuntimeCoreJsObjectKeys, _comRobobeakRustieIndex, _comRobobeakRustiePluginsMarkdownMarked, _babelRuntimeHelpersInteropRequireDefault) {
  'use strict';
  ...
  var _marked = (0, _babelRuntimeHelpersInteropRequireDefault['default'])(_comRobobeakRustiePluginsMarkdownMarked);
          ...
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              (0, _babelRuntimeCoreJsObjectKeys['default'])(files).forEach(function (path) {
                var file = files[path];
                var contentString = uint8ToString(file.content);
                file.content = stringToUint8((0, _marked['default'])(contentString));
              });
              return context$2$0.abrupt('return', files);
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('/com/robobeak/rustie/plugins/markdown/marked', ['exports'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports);
  } else {
    var mod = {
    ...
    factory(mod.exports);
    global.comRobobeakRustiePluginsMarkdownMarked = mod.exports;
  }
