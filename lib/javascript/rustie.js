...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', './errors', './data', './plugin'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('./errors'), require('./data'), require('./plugin'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.errors, global.data, global.plugin);
    global.index = mod.exports;
  }
})(this, function (exports, _errors, _data, _plugin) {
  'use strict';
      ...
      value: function process(files) {
        ...
        return regeneratorRuntime.async(function process$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              list = Object.assign(Object.create(null), files);
              _iteratorNormalCompletion = true;
              _didIteratorError = false;
              _iteratorError = undefined;
              context$2$0.prev = 4;
              _iterator = this._processors[Symbol.iterator]();
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', './rustie', './plugins/front-matter/index', './plugins/markdown/index', './dal/node/file-reader', './dal/node/file-writer'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('./rustie'), require('./plugins/front-matter/index'), require('./plugins/markdown/index'), require('./dal/node/file-reader'), require('./dal/node/file-writer'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.rustie, global.index, global.index, global.fileReader, global.fileWriter);
    global.rustieNodeFile = mod.exports;
  }
})(this, function (exports, _rustie, _pluginsFrontMatterIndex, _pluginsMarkdownIndex, _dalNodeFileReader, _dalNodeFileWriter) {
  'use strict';
  ...
  var NodeRustie = (function (_Rustie) {
    function NodeRustie() {
      ...
      this.addPlugins(new _pluginsFrontMatterIndex.FrontMatter(), new _pluginsMarkdownIndex.Markdown());
    }
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', './pipeline'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('./pipeline'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.pipeline);
    global.rustie = mod.exports;
  }
})(this, function (exports, _pipeline2) {
  'use strict';
  ...
  var Rustie = (function () {
    ...
    _createClass(Rustie, [{
      ...
      value: function build(from, to) {
        var files, processed;
        return regeneratorRuntime.async(function build$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              context$2$0.next = 2;
    ...
    _createClass(Reader, [{
      ...
      value: function read() {
        return regeneratorRuntime.async(function read$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              return context$2$0.abrupt('return', Object.create(null));
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', '../reader'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('../reader'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.reader);
    global.nullReader = mod.exports;
  }
})(this, function (exports, _reader) {
  'use strict';
  ...
  var NullReader = (function (_Reader) {
    function NullReader() {
      _classCallCheck(this, NullReader);
    ...
    _inherits(NullReader, _Reader);

    _createClass(NullReader, [{
      key: 'read',
      ...
      value: function read() {
        return regeneratorRuntime.async(function read$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              return context$2$0.abrupt('return', _get(Object.getPrototypeOf(NullReader.prototype), 'read', this).call(this));
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', '../writer'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('../writer'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.writer);
    global.nullWriter = mod.exports;
  }
})(this, function (exports, _writer) {
  'use strict';
  ...
  var NullWriter = (function (_Writer) {
    function NullWriter() {
      _classCallCheck(this, NullWriter);
    ...
    _inherits(NullWriter, _Writer);

    _createClass(NullWriter, [{
      key: 'write',
      ...
      value: function write() {
        return regeneratorRuntime.async(function write$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              return context$2$0.abrupt('return', _get(Object.getPrototypeOf(NullWriter.prototype), 'write', this).call(this));
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', '../../data', './io'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('../../data'), require('./io'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.data, global.io);
    global.rhinoIo = mod.exports;
  }
})(this, function (exports, _data, _io) {
  'use strict';
  ...
  function readdir(path) {
    ...
    return regeneratorRuntime.async(function readdir$(context$1$0) {
  ...
  function readFileContent(filePath) {
    return regeneratorRuntime.async(function readFileContent$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
  ...
  var RhinoIO = (function (_IO) {
    ...
    _inherits(RhinoIO, _IO);

    _createClass(RhinoIO, [{
      key: 'read',
        ...
        return regeneratorRuntime.async(function write$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              ...
              context$2$0.next = 5;
              return Promise.all(writerResult);
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'promisify-node', 'path', '../reader', '../../data'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('promisify-node'), require('path'), require('../reader'), require('../../data'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.promisify, global.path, global.reader, global.data);
    global.fileReader = mod.exports;
  }
})(this, function (exports, _promisifyNode, _path, _reader, _data) {
  'use strict';
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'promisify-node', 'path', '../writer'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('promisify-node'), require('path'), require('../writer'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.promisify, global.path, global.writer);
    global.fileWriter = mod.exports;
  }
})(this, function (exports, _promisifyNode, _path, _writer) {
  'use strict';
  ...
  function writeFile(data, to) {
    return regeneratorRuntime.async(function writeFile$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          context$1$0.next = 2;
          return fs.writeFile(to, new Buffer(data.content));
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', '../../index', './js-yaml'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('../../index'), require('./js-yaml'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.index, global.jsyaml);
    global.index = mod.exports;
  }
})(this, function (exports, _index, _jsYaml) {
  'use strict';
