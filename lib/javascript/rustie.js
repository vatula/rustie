(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "babel-runtime/helpers/create-class", "babel-runtime/helpers/class-call-check", "babel-runtime/core-js/object/define-property", "babel-runtime/core-js/object/create"], factory);
...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "babel-runtime/helpers/inherits", "babel-runtime/helpers/get", "babel-runtime/helpers/class-call-check", "babel-runtime/core-js/object/define-property"], factory);
  } else if (typeof exports !== "undefined") {
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'babel-runtime/core-js/object/define-property', './errors', './rustie', './plugin', './dal/reader', './dal/writer', './data'], factory);
  } else if (typeof exports !== 'undefined') {
...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "babel-runtime/helpers/create-class", "babel-runtime/helpers/class-call-check", "babel-runtime/core-js/object/define-property", "babel-runtime/regenerator", "babel-runtime/core-js/object/assign", "babel-runtime/core-js/object/create", "babel-runtime/core-js/get-iterator"], factory);
  } else if (typeof exports !== "undefined") {
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', './errors'], factory);
  } else if (typeof exports !== 'undefined') {
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', './pipeline'], factory);
  } else if (typeof exports !== 'undefined') {
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', 'babel-runtime/core-js/object/create', '../errors'], factory);
  } else if (typeof exports !== 'undefined') {
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'babel-runtime/helpers/inherits', 'babel-runtime/helpers/get', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', '../../index'], factory);
  } else if (typeof exports !== 'undefined') {
...
(function (global, factory) {
  ...
  var IO = (function () {
    function IO() {
      (0, _babelRuntimeHelpersClassCallCheck['default'])(this, IO);

      if (this.constructor === IO) {
        throw new _errors.RustieAbstractClassError('cannot instantiate class IO. IO is an abstract class');
      }
    }

    (0, _babelRuntimeHelpersCreateClass['default'])(IO, [{
      key: 'read',
...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'babel-runtime/helpers/inherits', 'babel-runtime/helpers/create-class', 'babel-runtime/helpers/class-call-check', 'babel-runtime/core-js/object/define-property', 'babel-runtime/regenerator', 'babel-runtime/core-js/promise', 'babel-runtime/core-js/object/create', 'babel-runtime/core-js/object/keys', '../../data', './io'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('babel-runtime/helpers/inherits'), require('babel-runtime/helpers/create-class'), require('babel-runtime/helpers/class-call-check'), require('babel-runtime/core-js/object/define-property'), require('babel-runtime/regenerator'), require('babel-runtime/core-js/promise'), require('babel-runtime/core-js/object/create'), require('babel-runtime/core-js/object/keys'), require('../../data'), require('./io'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global._inherits, global._createClass, global._classCallCheck, global._Object$defineProperty, global._regeneratorRuntime, global._Promise, global._Object$create, global._Object$keys, global.data, global.io);
    global.rhinoIo = mod.exports;
  }
})(this, function (exports, _babelRuntimeHelpersInherits, _babelRuntimeHelpersCreateClass, _babelRuntimeHelpersClassCallCheck, _babelRuntimeCoreJsObjectDefineProperty, _babelRuntimeRegenerator, _babelRuntimeCoreJsPromise, _babelRuntimeCoreJsObjectCreate, _babelRuntimeCoreJsObjectKeys, _data, _io) {
  'use strict';
  ...
  function readdir(path) {
    var result, stack, entry, iterator;
    return _babelRuntimeRegenerator['default'].async(function readdir$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          result = [];
          stack = [new java.io.File(path)];

          while (stack.length) {
            entry = stack.shift();

            if (entry.isDirectory()) {
              for (iterator = entry.listFiles().iterator(); iterator.hasNext();) {
  ...
  function memoizerFactory(from, files) {
    return function memoizer(memo, filePath, i) {
      var file = new java.io.File(from).toURI().relativize(new java.io.File(filePath).toURI()).getPath();
      memo[file] = files[i];
      return memo;
    };
  }
  ...
  function readFileContent(filePath) {
    return _babelRuntimeRegenerator['default'].async(function readFileContent$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          return context$1$0.abrupt('return', java.nio.file.Files.readAllBytes(java.nio.file.Paths.get(filePath)));
    ...
    return _babelRuntimeRegenerator['default'].async(function readFile$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        ...
        case 2:
          ...
          return context$1$0.abrupt('return', new _data.Data(new Uint8Array(contents)));
  ...
  function asyncBulkWriterFactory(writer, to, files) {
    return function asyncBulkWriter(filePath) {
      ...
      return _babelRuntimeRegenerator['default'].async(function asyncBulkWriter$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            file = java.nio.file.FileSystems.getDefault().getPath(to).resolve(filePath).normalize();

            new java.io.File(to).mkdirs();
            context$2$0.next = 4;
            return writer(files[filePath], file);
  ...
  var RhinoIO = (function (_IO) {
    function RhinoIO() {
      (0, _babelRuntimeHelpersClassCallCheck['default'])(this, RhinoIO);

      if (_IO != null) {
        _IO.apply(this, arguments);
      }
    }

    (0, _babelRuntimeHelpersInherits['default'])(RhinoIO, _IO);
    (0, _babelRuntimeHelpersCreateClass['default'])(RhinoIO, [{
      key: 'read',
        ...
        return _babelRuntimeRegenerator['default'].async(function read$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            ...
            case 2:
              ...
              context$2$0.next = 5;
              return _babelRuntimeCoreJsPromise['default'].all(filePaths.map(readFile));
        ...
        return _babelRuntimeRegenerator['default'].async(function write$(context$2$0) {
          while (1) switch (context$2$0.prev = context$2$0.next) {
            case 0:
              ...
              context$2$0.next = 5;
              return _babelRuntimeCoreJsPromise['default'].all(writerResult);
